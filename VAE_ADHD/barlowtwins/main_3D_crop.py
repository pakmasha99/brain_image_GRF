...
from dataset import MRI_dataset, transform_yAware_all , transform_yAware_cutout, transform_yAware_crop
...
def main_worker(gpu, args):
    ...
    dataset = MRI_dataset(data_path, "train",1, transform_yAware_crop,(1,99, 117, 95), MNI = True)
    ...
    loader = torch.utils.data.DataLoader(
        ...
        pin_memory=True, sampler=sampler, drop_last = True, persistent_workers = True) #persistent workers : True because we don't wnat to reload the whole thing, #drop_last true because prevent spike
