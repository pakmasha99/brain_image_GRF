...
from dataset import MRI_dataset, transform_yAware_all , transform_yAware_cutout
...
def main_worker(gpu, args):
    ...
    dataset = MRI_dataset(data_path, "train",1, transform_yAware_cutout,(1,99, 117, 95), MNI = True)
