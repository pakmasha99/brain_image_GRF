...
def main_worker(gpu, args):
    ...
    dataset = MRI_dataset(data_path, "train",1, transform_yAware_all,(1,99, 117, 95), MNI = True, gpu = args.rank)  #modified, gpu number taken as input
    ...
    loader = torch.utils.data.DataLoader(
        dataset, batch_size=per_device_batch_size, num_workers=args.workers, 
         sampler = sampler, drop_last = True) #removed pin_memory since data already in in GPU, and drop_last=  True 로 set, as per : https://stackoverflow.com/questions/47824598/why-does-my-training-loss-have-regular-spikes
         #pin_memory=True, sampler=sampler, drop_last = True) #drop_last = True 로 set, as per : https://stackoverflow.com/questions/47824598/why-does-my-training-loss-have-regular-spikes
