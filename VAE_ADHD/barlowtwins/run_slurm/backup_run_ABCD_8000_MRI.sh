...
python $base_dir/main_3D.py /scratch/connectome/3DCNN/data/1.ABCD/1.sMRI_fmriprep/preprocessed_masked --checkpoint-dir $base_dir/checkpoint_ABCD_batch_${batch_size}_6_a5000_gpu\
 --batch-size $batch_size --print-freq 10 --save-every 10 --epochs 100
