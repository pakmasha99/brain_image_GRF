...
#SBATCH --job-name UKB_T1_1000_SSL  #job name을 다르게 하기 위해서
#SBATCH --nodes=1
#SBATCH --nodelist=node1 #used node2
#SBATCH -t 48:00:00 # Time for running job #길게 10일넘게 잡음
#SBATCH -o ./shell_output/1000_SSL_output_%J.out #%j : job id 가 들어가는 것
#SBATCH -e ./shell_output/1000_SSL_error_%J.error
#SBATCH --ntasks=1
...
python $base_dir/main_3D.py /scratch/connectome/mieuxmin/UKB_t1_MNI/unzip_mni_1000/ --checkpoint-dir $base_dir/checkpoint_batch_${batch_size}_4_a5000_gpu\
 --batch-size $batch_size --print-freq 1 --save-every 10 --epochs 100
