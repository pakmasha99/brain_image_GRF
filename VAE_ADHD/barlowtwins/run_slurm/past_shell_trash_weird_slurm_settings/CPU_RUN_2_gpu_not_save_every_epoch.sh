...
#SBATCH -o ./shell_output/CPU_ABCD_not_save_SSL_output_%J.out #%j : job id 가 들어가는 것
#SBATCH -e ./shell_output/CPU_ABCD_not_save_SSL_error_%J.error
#SBATCH --ntasks=1
...
epochs=10 #epoch을 무엇을 두느냐에 따라 완전히 달라짐! 
...
python $base_dir/BACKUP_main_3D_not_save.py /scratch/connectome/3DCNN/data/1.ABCD/1.sMRI_fmriprep/preprocessed_masked --checkpoint-dir $base_dir/REAL_TRAINING_not_save_checkpoint_ABCD_batch_${batch_size}_2_gpu_epoch_${epochs}_lambd_${lambd}_DROP_LAST_BATCH\
