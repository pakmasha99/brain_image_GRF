...
#SBATCH --job-name crop_lambda_20%_64_ABCD_T1_8000_SSL  #job name을 다르게 하기 위해서
#SBATCH --nodes=1
...
python $base_dir/main_3D_crop.py /scratch/connectome/3DCNN/data/1.ABCD/1.sMRI_fmriprep/preprocessed_masked  --checkpoint-dir $base_dir/REAL_TRAINING_CROP_checkpoint_ABCD_batch_${batch_size}_2_gpu_epoch_${epochs}_lambd_${lambd}_DROP_LAST_BATCH\
