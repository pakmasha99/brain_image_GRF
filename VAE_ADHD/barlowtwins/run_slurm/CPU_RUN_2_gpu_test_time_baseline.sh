...
#SBATCH --mem-per-cpu=25GB #최대한 GPU VRAM 하나+ extra정도는 있어야 하지 않을까
#SBATCH --cpus-per-task=4 #16
...
python $base_dir/BACKUP_main_3D.py /tmp/VAE_ADHD/ABCD_preprocessec_masked   --checkpoint-dir $base_dir/test_time/TEST_persistent_False_Baseline\
