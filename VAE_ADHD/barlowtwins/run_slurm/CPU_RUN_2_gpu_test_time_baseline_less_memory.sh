...
python $base_dir/BACKUP_main_3D.py /tmp/VAE_ADHD/ABCD_preprocessec_masked   --checkpoint-dir $base_dir/test_time/TEST_persistent_False_Baseline_LESS_MEMORY_MORE_CPU\
