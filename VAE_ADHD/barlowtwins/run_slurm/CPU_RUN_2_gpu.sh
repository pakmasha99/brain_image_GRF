...
#SBATCH --job-name 64lambda_20%_64_ABCD_T1_8000_SSL  #job name을 다르게 하기 위해서
#SBATCH --nodes=1
#SBATCH --nodelist=node1 #used node2
#SBATCH -t 3:00:00 # Time for running job #길게 10일넘게 잡음
...
python $base_dir/main_3D.py /tmp/VAE_ADHD/ABCD_preprocessec_masked --checkpoint-dir $base_dir/SEE_IT_REAL_TRAINING_checkpoint_ABCD_batch_${batch_size}_2_gpu_epoch_${epochs}_lambd_${lambd}_DROP_LAST_BATCH\
