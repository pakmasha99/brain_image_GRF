...
###python3 main_optuna_fix_5_dev_amp.py --pretrained_path ./weights/y-Aware_Contrastive_MRI_epoch_99.pth --mode finetuning --train_num 50 --layer_control tune_all --stratify iter_strat --random_seed 0 --task test --input_option yAware --binary_class True --save_path finetune_trash/with_AMP --AMP True --run_where sdcc
...
##above : AMP with and without


##main_optuna_fix_4.py --pretrained_path /scratch/connectome/study_group/VAE_ADHD/junbeom_weights/UKByAa64a.pth --mode finetuning --train_num 80 --layer_control tune_all --stratify strat --random_seed 0 --task ABCD_sex --input_option yAware --batch_size 32 --save_path finetune_ABCD_fix_3_full_epoch --binary_class True --run_where lab --lr_schedule True
    ...
    def __init__(self, net, loss, loader_train, loader_val, loader_test, config, task_name, train_num, layer_control, n_iter, pretrained_path, FOLD, wandb, trial): # ADNI
        ...
        if config.lr_schedule :  #if schedule exists
            if config.lr_schedule == "lr_plateau" : 
                ...
                self.scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(self.optimizer,'min', factor = 0.8) #could vary patience
