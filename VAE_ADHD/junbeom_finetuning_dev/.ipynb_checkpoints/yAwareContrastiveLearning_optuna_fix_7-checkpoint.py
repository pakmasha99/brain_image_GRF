...
###python3 main_optuna_fix_7.py --pretrained_path ./weights/y-Aware_Contrastive_MRI_epoch_99.pth --mode finetuning --train_num 50 --layer_control tune_all --stratify iter_strat --random_seed 0 --task test --input_option yAware --binary_class True --save_path finetune_trash --AMP True --run_where lab --nb_epochs 30
