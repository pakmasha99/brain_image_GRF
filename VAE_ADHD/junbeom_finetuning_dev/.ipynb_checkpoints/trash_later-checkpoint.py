###python3 main_DEBUG.py --pretrained_path ./weights/y-Aware_Contrastive_MRI_epoch_99.pth --mode finetuning --train_num 10 --task_name AD/CN --layer_control freeze --stratify balan --random_seed 0
...
class yAwareCLModel:
    ...
    def fine_tuning(self):
        ...
        print(f"========after loading from ckpt =======")
        print(f" training mode? : {self.model.module.training}")
        print("classifier.weight : ",torch.std(self.model.module.classifier.weight))
        print("classifier.bias   : ",torch.std(self.model.module.classifier.bias))
