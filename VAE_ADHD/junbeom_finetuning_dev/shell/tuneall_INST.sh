...
#SBATCH --job-name tune_20U_inst_BN_wo_cpu_None_hyper_tune_pll_yfreeze  #job name을 다르게 하기 위해서
#SBATCH -p volta
...
wd_list=( 5e-4 1e-4 5e-5 1e-8 )

for wd in "${wd_list[@]}"
do
#no RAM vail, so batch 8 discarded
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 0 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 1 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 2 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 3 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 4 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
#python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 5 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\ 
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 0 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 1 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 2 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN ; wait
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 3 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 4 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify strat --random_seed 5 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_2 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN ; wait 
done
