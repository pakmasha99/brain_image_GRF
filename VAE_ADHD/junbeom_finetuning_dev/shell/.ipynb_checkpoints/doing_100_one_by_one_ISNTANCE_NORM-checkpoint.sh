...
#SBATCH --job-name inst_BN_wo_cpu_None_hyper_tune_pll_yfreeze  #job name을 다르게 하기 위해서
#SBATCH -p voltadebug
...
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control freeze --stratify strat --random_seed 5 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control freeze --stratify strat --random_seed 6 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN &\
python3 main.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control freeze --stratify strat --random_seed 7 --task $task --input_option yAware --learning_rate $lr --batch_size $batch_1 --weight_decay $wd --BN inst --save_path finetune_results_InstanceBN ; wait
