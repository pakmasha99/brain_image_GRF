...
sleep 1 ; python3 main_optuna_fix_5_lr_schedule.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify iter_strat --random_seed 0 --task $task --input_option yAware --batch_size $batch_1 --save_path finetune_ABCD_fix_5_lr_schedule/SGDR_3 --binary_class True --run_where lab --lr_schedule SGDR_3 & \
sleep 10 ; python3 main_optuna_fix_5_lr_schedule.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify iter_strat --random_seed 0 --task $task --input_option yAware --batch_size $batch_1 --save_path finetune_ABCD_fix_5_lr_schedule/SGDR_4 --binary_class True --run_where lab --lr_schedule SGDR_4
