...
#SBATCH --job-name strict_ADHD  #job name을 다르게 하기 위해서
...
python3 main_optuna_fix_7.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify iter_strat --random_seed 0 --task $task --input_option yAware --batch_size $batch_1 --save_path finetune_RESULTS/TEST_4/ADHD_strict_upweight_no_prune --binary_class True --run_where lab --early_criteria loss --lr_schedule cosine_annealing_decay --lr_range 2e-6/2e0 --wd_range 1e-2/1e1 --workers 16 --wandb_name TEST_2 --AMP True --prune False --nb_epochs 100 --upweight True --patience 20
