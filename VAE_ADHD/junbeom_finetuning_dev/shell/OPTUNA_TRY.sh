...
#SBATCH --job-name UKBfr100_hyper_tune_pll_yfreeze  #job name을 다르게 하기 위해서
#SBATCH -p volta
#SBATCH -t 12:00:00 #volta can only do four hours for voltadebug...
#SBATCH -N 1
...
sleep 4 ; python3 main_optuna_fix.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control freeze --stratify strat --random_seed 3 --task $task --input_option yAware --batch_size $batch_1 --save_path finetune_test --binary_class True --run_where sdcc ; wait
