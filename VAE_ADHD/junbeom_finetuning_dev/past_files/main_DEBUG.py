...
#    """
        ...
        #    """
        #    
        #raise ValueError("FIX HERE!! (make it work for different datasets")
        if "ADNI" in config.task or config.task == "test" : #change it so that this is the case for 
            ...
            **must make sure that ALL these list have the same order!!
            ...
            #raise NotImplementedError("check if the batch created by this actually has the img shape we want to!!! ")
