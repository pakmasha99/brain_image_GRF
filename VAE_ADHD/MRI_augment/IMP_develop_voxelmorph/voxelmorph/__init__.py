...
#=======REMOVED SO FAR, AS NEURITE NEEDEDD TENSORFLOW TO WORK, SO WON'T USE IT 
#(besides, neurite is only used in the tensorflow implmeentation)====#
#import neurite #removed
#minv = '0.2'
...
#=====ADDED=====#
##added force use pytorch backend (export doesn't work)
backend = "pytorch"
#===============#
