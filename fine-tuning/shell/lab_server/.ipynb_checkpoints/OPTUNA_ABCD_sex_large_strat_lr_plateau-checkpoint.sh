...
#SBATCH --job-name lr_plateau_sex_large  #job name을 다르게 하기 위해서
#SBATCH -t 240:00:00 #volta can only do four hours for voltadebug...
#SBATCH -N 1
