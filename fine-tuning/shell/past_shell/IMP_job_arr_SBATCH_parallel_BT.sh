...
#SBATCH --job-name BT_pll  #job name을 다르게 하기 위해서
#SBATCH --nodes=1
...
weight_list=( ${base_dir}/ABCDbt128a102.pth ${base_dir}/ABCDbt64a0204.pth ${base_dir}/ABCDbt32a102.pth ${base_dir}/ABCDbt16a102.pth ${base_dir}/ABCDbt128cu102.pth ${base_dir}/ABCDbt128cr102.pth ${base_dir}/ABCDbt64a102.pth ${base_dir}/ABCDbt64cu102.pth ${base_dir}/ABCDbt64a102_epoch10.pth ${base_dir}/ABCDbt64cr102.pth )
...
python3 main_DEBUG.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control freeze --stratify balan --random_seed 5 --task $task --input_option BT_org --learning_rate 1e-3 ; wait
...
python3 main_DEBUG.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify balan --random_seed 2 --task $task --input_option BT_org ; wait
...
python3 main_DEBUG.py --pretrained_path $weight --mode finetuning --train_num $num --layer_control tune_all --stratify balan --random_seed 5 --task $task --input_option BT_org ; wait
