##fix_7 : trial prune (with takikng into account reporting the AUROC value) and upweighting
...
from yAwareContrastiveLearning_optuna_fix_7 import yAwareCLModel
...
parser.add_argument("--stratify", type=str, choices=["strat", "balan", "iter_strat", "balan_iter_strat", "balan_strat"], required=False, # ADNI
...
parser.add_argument('--patience',required = False, default = 100, type = int, help = "how much patience?" )
...
def main(trial):
    ...
    if args.nb_epochs : #i.e. nb_epochs was set by CLI
        config.nb_epochs = args.nb_epochs #over writes nb_epochs that was set
    else :
        pass #i.e. config nb epochs are used automatically
...
if __name__ == "__main__":    
    ...
    #study.enqueue_trial(
    #{
    #    "learning_rate": 0.0001947807947898847,
    #    "weight_decay": 0.0028403780495017527,
    #}
    #)
    ...
    #study.enqueue_trial(
    #{
    #    "learning_rate": 0.00001947807947898847,
    #    "weight_decay": 0.0028403780495017527,
    #}
    #) #"BN_option": 'inst',
    #change to 200 later!
